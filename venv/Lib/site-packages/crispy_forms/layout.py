...
class Field(LayoutObject):
    ...
    attrs : dict
        ...
        attributes. e.g. ``data_id: 'test.py'`` in the attrs dict will become
        ``data-id='test.py'`` on the field's ``<input>``.
    ...
    **kwargs : dict, optional
    ...
    def __init__(self, *fields, css_class=None, wrapper_class=None, template=None, **kwargs):
        ...
        # We use kwargs as HTML attributes, turning data_id='test.py' into data-id='test.py'
